...
>("admin/addNewUser", async (body, { rejectWithValue }) => {
    try {
        const response = await CustomAxios.post(`/admin/adduser`, { email: body.email, name: body.name }, {
...
>("admin/editEmail", async (body, { rejectWithValue }) => {
    try {
        const response = await CustomAxios.post(`/admin/editemail`, { email: body.email, newEmail: body.newEmail }, {
            withCredentials: true,
        });
        return response;
    } catch (error: any) {
...
>("admin/deleteOldRem", async (email, { rejectWithValue }) => {
    try {
        const response = await CustomAxios.post(`/admin/deleteoldrem`, { email: email }, {
            withCredentials: true,
        });
        return response;
    } catch (error: any) {
...
>("admin/addOldRem", async (body, { rejectWithValue }) => {
    try {
        const response = await CustomAxios.post(`/admin/addoldrem`, { email: body.email, content: body.content, file: body.file }, {
            withCredentials: true,
            headers: {
...
>("admin/addAdmin", async (body, { rejectWithValue }) => {
    try {
        const response = await CustomAxios.post(`/admin/addadmin`, { email: body.email, name: body.name }, {
            withCredentials: true,
        });
        return response;
    } catch (error: any) {
