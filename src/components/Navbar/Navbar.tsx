...
const Navbar = ({ isNavbarOpen, isNotificationOpen, toggleNavbar, toggleNotification }: { isNavbarOpen: boolean, isNotificationOpen: boolean, toggleNavbar: () => void, toggleNotification: () => void }) => {
  return (
